...
import com.avtograv.weatherapp.data.network.retrofit.response.onecall.Current
import com.avtograv.weatherapp.data.network.retrofit.response.onecall.DailyItem
import com.avtograv.weatherapp.data.network.retrofit.response.onecall.HourlyItem
import com.avtograv.weatherapp.data.network.retrofit.response.onecall.MinutelyItem
